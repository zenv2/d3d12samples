...
namespace render
{
    Swapchain::Swapchain(const Window& window, Device& device, Commander& commander, const DXGI_FORMAT rtvFormat, const DXGI_FORMAT dsvFormat) :
        ...
        m_rtvDescriptorSize(0)
    {
        ...
        if( m_dsvFormat != DXGI_FORMAT_UNKNOWN )
        {
            ...
            depthOptimizedClearValue.Format = m_dsvFormat;
